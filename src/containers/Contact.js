        ...
        return (
            <Paper className={classes.main}>
                <div className="text_div">
                    <p className="p">Если Вы считаете материал, на который были перенаправлены, неприемлемым по этическим или иным
                    соображениям, информацию не правдивой или просто бесполезной, пожалуйста дайте нам знать, и мы
                        удалим ссылку на данный материал. Для этого просто заполните форму и нажмите отправить.</p>
                </div>
